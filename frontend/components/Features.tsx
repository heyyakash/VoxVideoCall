...
export const Box: FC<BoxProps> = ({ children }) => {
  return (
    <div className='w-full h-[80vh]  lg:min-h-[100vh] relative'>
      {children}
    </div>
  )
}
  ...
  return (
    <>
      ...
      <div className='w-full h-[100vh] relative flex-center flex-col'>
        <h1 className='bg-gradient-to-r -mt-[5rem] from-red-400 text-center to-white bg-clip-text text-transparent'>Room creation in 1 click </h1>
        <p className='text-sm md:text-lg '>Want to call friends? Just one click away!</p>
  ...
  return (
    <>
      ...
      <div className='w-full h-[100vh] relative flex-center  flex-col'>
        ...
        <p className='text-sm md:text-lg '>Connect to Everyone!</p>
        <div className=' relative h-auto w-[350px] mt-5'>
          <div className=' relative h-auto w-[350px] mt-5'>
